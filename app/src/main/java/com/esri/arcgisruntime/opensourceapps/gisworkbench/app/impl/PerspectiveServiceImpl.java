...
public class PerspectiveServiceImpl implements PerspectiveService {
    ...
    private final ReadOnlyListWrapper<PerspectiveProviderService> perspectiveProviderServices =
            new ReadOnlyListWrapper<>(FXCollections.observableList(new CopyOnWriteArrayList<>())
    );
